...
declaration_specifiers ::= storage_struct_specifier*  type_qualifier* type_specifier ;
storage_struct_specifier::= "extern" | "static" ;
type_specifier         ::= "void" | "int" | "uint" | "short" | "ushort" | "long" | "ulong"
                         | "float" | "double" | "quad" | "bool" | "char" | "uchar"
                         | identifier
                         | template_type
                         ;
template_type          ::= identifier template ;
...
struct_definition       ::= "struct" "{" { struct_member } "}" ";" ;

struct_member           ::= type_specifier identifier ;
...
constant               ::= number | number "u" | double | double "f" | double "q" 
                          | char | string ;
